...
class CErkSV10App : public AcRxArxApp {

public:
	CErkSV10App () : AcRxArxApp () {}
	...
	// function of the CErkSV10App class.
	...
	// ACED_ARXCOMMAND_ENTRY_AUTO(CErkSV10App, ErksMyGroup, MyCommand, MyCommandLocal, ACRX_CMD_MODAL)
	static void ErksMyGroupMyCommand () {
		// Put your command code here

	}

	// Modal Command with pickfirst selection
	// ACED_ARXCOMMAND_ENTRY_AUTO(CErkSV10App, ErksMyGroup, MyPickFirst, MyPickFirstLocal, ACRX_CMD_MODAL | ACRX_CMD_USEPICKSET)
	static void ErksMyGroupMyPickFirst () {
		ads_name result ;
	...
	// ACED_ARXCOMMAND_ENTRY_AUTO(CErkSV10App, ErksMyGroup, MySessionCmd, MySessionCmdLocal, ACRX_CMD_MODAL | ACRX_CMD_SESSION)
	static void ErksMyGroupMySessionCmd () {
		// Put your command code here
	}
	...
	// or integer.
	// ACED_ADSFUNCTION_ENTRY_AUTO(CErkSV10App, MyLispFunction, false)
...
ACED_ADSSYMBOL_ENTRY_AUTO(CErkSV10App, MyLispFunction, false)
